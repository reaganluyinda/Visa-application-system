...
<html>
    ...
    <body>
        <!---the sidebar-->
     <div class="sidebar">
         <a  href="managerview.php"><i class="fa fa-home"></i>&nbsp;Home</a>
         <a class="active" href="applicants.php"><i class="fa fa-envelope"></i>&nbsp;Applicants</a>
          <a href="#signout"><i class="fa fa-sign-out-alt"></i>&nbsp;Sign out</a>
        </div> 
        <!--page content-->
        <div class="content">
            <h2> Applicants information</h2><br>
            <h5>Applicants with Awarded Visas</h5>
            <table class="table">
          <thead>       
    <tr>
      <th scope="col">NIN</th>
...
if ($result->num_rows > 0){
    ...
    echo "0 results";
            ...
            <br>
            <div class="rejected">
            <h5>Applicants with Rejected Visas</h5>
            <table class="table">
          <thead>       
    <tr>
      <th scope="col">NIN</th>
